...
Ziperase Ltd. <https://ziperase.com/>
...
Subject: jurisdictionC = GB, businessCategory = Private Organization, serialNumber = 11995552, C = GB, L = Leeds, O = Ziperase Ltd, CN = Ziperase Ltd
```

*******************************************************************************
### What product or service is this for?
*******************************************************************************
Ziperase create bootable software products to erase storage media, used in enterprise and high-volume recycling settings.

*******************************************************************************
### What's the justification that this really does need to be signed for the whole world to be able to boot it?
*******************************************************************************
A core principle of full disk erasure is to provide a trusted certificate of completion for compliance with various global standards.
Secure boot support ensures that nobody can modify our boot chain, and break that trust.
On a practical level, most of our users do not have the ability to bypass secure boot due to the high volume of machines they process, and in some cases do not have physical access.

*******************************************************************************
### Why are you unable to reuse shim from another distro that is already signed?
*******************************************************************************
We wish to retain the ability to apply patches to kernel drivers and modify config to support specific hardware.
...
*******************************************************************************
https://github.com/ze-colinmyers/shim-review
...
*******************************************************************************
These commits are all present in v6.12.23.
...
*******************************************************************************
Yes, we patch some drivers to support specific hardware.

*******************************************************************************
### Do you use an ephemeral key for signing kernel modules?
### If not, please describe how you ensure that one kernel build does not load modules built for another kernel.
*******************************************************************************
Yes and we use the following configuration:
...
*******************************************************************************
Keys are stored on a FIPS 140-2 HSM in a restricted-access location.
...
about this.
*******************************************************************************
Yes and it has the CA constraint.
...
shim.ziperase,1,Ziperase,shim,16.0,mail:security@ziperase.com
```
...
*******************************************************************************
```all_video efinet ext2 fat gfxmenu gfxterm gfxterm_background halt http iso9660 jpeg linux ls memdisk normal part_gpt part_msdos png reboot search tar test tftp true video```
...
*******************************************************************************
grub-2.12 from <https://ftp.gnu.org/gnu/grub/grub-2.12.tar.gz>
...
*******************************************************************************
N/A - grub only launches locked down Linux kernel.
